jQuery(function($){
    ...
    $('.btnMenuOpen').click(function() {
        $(this).find('a').filter(':not(.goto_list)').removeAttr('href');
                ...
                sliderLi.each(function (i, el) {
                    ...
                    if((i+1) % e._view == 0) {
                        ...
                        if(pagingType == 'sliderPaging colorG'){
                            //alert('그린');
                            pagingTarget.append('<a href="#none" class="btnPage"><img src="http://www.abnkorea.co.kr/_ui/mobile/images/common/btn_slideg_off.png" alt="' + altTxt + '"></a>');
                        }else   if(pagingType == 'sliderPaging colorR'){
                            //alert('레드');
                            pagingTarget.append('<a href="#none" class="btnPage"><img src="http://www.abnkorea.co.kr/_ui/mobile/images/common/btn_slide_off.png" alt="' + altTxt + '"></a>');
                        }else   if(pagingType == 'sliderPaging colorW'){
                            //alert('화이트');
                            pagingTarget.append('<a href="#none" class="btnPage"><img src="http://www.abnkorea.co.kr/_ui/mobile/images/common/btn_slidew_off.png" alt="' + altTxt + '"></a>');
                        }else {
                            //alert('블루');
                            pagingTarget.append('<a href="#none" class="btnPage"><img src="http://www.abnkorea.co.kr/_ui/mobile/images/common/btn_slideb_off.png" alt="' + altTxt + '"></a>');
                        }
                    }
                });
            ...
            initComplete : function (e) {
                ...
                sliderLi5.each(function (i, el) {
                    ...
                    if((i+1) % e._view == 0) {
                        ...
                        if(pagingType == 'sliderPaging colorG'){
                            //alert('그린');
                            pagingTarget5.append('<a href="#none" class="btnPage"><img src="http://www.abnkorea.co.kr/_ui/mobile/images/common/btn_slideg_off.png" alt="' + altTxt + '"></a>');
                        }else   if(pagingType == 'sliderPaging colorR'){
                            //alert('레드');
                            pagingTarget5.append('<a href="#none" class="btnPage"><img src="http://www.abnkorea.co.kr/_ui/mobile/images/common/btn_slide_off.png" alt="' + altTxt + '"></a>');
                        }else   if(pagingType == 'sliderPaging colorW'){
                            //alert('화이트');
                            pagingTarget5.append('<a href="#none" class="btnPage"><img src="http://www.abnkorea.co.kr/_ui/mobile/images/common/btn_slidew_off.png" alt="' + altTxt + '"></a>');
                        }else {
                            //alert('블루');
                            pagingTarget5.append('<a href="#none" class="btnPage"><img src="http://www.abnkorea.co.kr/_ui/mobile/images/common/btn_slideb_off.png" alt="' + altTxt + '"></a>');
                        }
                    }
                });
        ...
        $(touchSliderId3).touchSlider2({
            ...
            initComplete : function (e) {
                ...
                sliderLi3.each(function (i, el) {
                    ...
                    if((i+1) % e._view == 0) {
                        pagingTarget3.append('<a href="#none" class="btnPage"><img src="http://www.abnkorea.co.kr/_ui/mobile/images/common/btn_slide_off.png" alt="' + altTxt + '"></a>');
                    }
                });
        ...
        touchSliderId2.touchSlider2({
            ...
            initComplete : function (e) {
                ...
                sliderLi2.each(function (i, el) {
                    ...
                    if((i) % e._view == 0) {
                        pagingTarget2.append('<a href="#none" class="btnPage"><img src="http://www.abnkorea.co.kr/_ui/mobile/images/common/btn_slide_off.png" alt="다음 2개 상품 보기"></a>');
                    }
                });
        ...
        touchSliderId2.touchSlider2({
            ...
            initComplete : function (e) {
                ...
                sliderLi2.each(function (i, el) {
                    ...
                    if((i) % e._view == 0) {
                        pagingTarget2.append('<a href="#none" class="btnPage"><img src="http://www.abnkorea.co.kr/_ui/mobile/images/common/btn_slide_off.png" alt="다음 3개 상품 보기"></a>');
                    }
                });
                pagingTarget2.find(".btnPage").bind("click", function (e) {
                    var i = $(this).index();
        ...
        touchSliderId2.touchSlider2({
            ...
            initComplete : function (e) {
                ...
                sliderLi2.each(function (i, el) {
                    ...
                    if((i) % e._view == 0) {
                        pagingTarget2.append('<a href="#none" class="btnPage"><img src="http://www.abnkorea.co.kr/_ui/mobile/images/common/btn_slide_off.png" alt="다음 4개 상품 보기"></a>');
                    }
    ...
    function moreListViewInit() {
        ...
        $moreBtn.on('click', function(ev) {
            if ($moreBtn.children('span').html() != 'TOP') {
                ...
                $.ajax({
                    url: "http://www.abnkorea.co.kr/mobile/services/sample.xml",
                    type: "GET",
                    data: {
...
function openChatConsultWindow(URL, obj) {
    $("#uiLayerPop_chat").remove();
    $.ajax({
        type     : 'GET',
        url      : "http://www.abnkorea.co.kr/customer/realtimechat",
        dataType : 'html',
        data     : null,
    ...
    /*$.ajax({
        type     : "GET",
        url      : "http://www.abnkorea.co.kr/customer/checkChatConsultAvailable",
        dataType : "json",
        success: function (data) {
...
function showToggle(){
    ...
    $('.deliveryIn .deliInputBox a.btnTgg img').attr('src','http://www.abnkorea.co.kr/_ui/mobile/images/content/btn_child_close.gif');
}
function hideToggle(){
    if (!$('.deliveryIn .deliInputBox').length) return;
    $('.deliveryIn .deliInputBox').removeClass('on');
    $('.deliveryIn .deliInputBox a.btnTgg img').attr('src','http://www.abnkorea.co.kr/_ui/mobile/images/content/btn_child_open.gif');
}
