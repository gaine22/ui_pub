...
function layerPopupOpen(e){
    ...
    // 암막
    var layerM =$('<div class="layerMask" id="layerMask" style="display:block"><img src="http://www.abnkorea.co.kr/_ui/mobile/images/common/bg_mask.png" alt=""></div>');
...
function loadingLayerS(oldVersion){
    var loadImg =$('<div class="loadingS" id="loadingS"' + (oldVersion ? 'style="z-index:10000"' : '') + '><img src="http://www.abnkorea.co.kr/_ui/mobile/images/common/loading.gif" alt="로딩중"></div>');
    var layerM =$('<div class="loadMask" id="loadMask" style="display:block;' + (oldVersion ? 'z-index:9999"' : '') + '"><img src="http://www.abnkorea.co.kr/_ui/mobile/images/common/bg_loading.png" alt=""></div>');
    if (loadImg.length){
        $('#loadingS').remove();
        $('#loadMask').remove();
    }
